...
## Repo Contents
  ### Data:</b>This folder  contains  data sets used in our project and origin of data
...
##### weighted logistic regression with tfidf vectorizer
![Alt text](https://github.com/DATA-606-FALL-2022/TEAM_A/blob/main/images/Picture3.png)

### Output comparison of all m/c learning models:

![Alt text](https://github.com/DATA-606-FALL-2022/TEAM_A/blob/main/images/Picture4.png)

### Deep learning models:
out of 4 deep learning models we found conv LSTM is workinh better than others.

![Alt text](https://github.com/DATA-606-FALL-2022/TEAM_A/blob/main/images/download%20(7).png)

### output comparison:

![Alt text](https://github.com/DATA-606-FALL-2022/TEAM_A/blob/main/images/Picture5.png)

### Visualization of Top 10 models:

![Alt text](https://github.com/DATA-606-FALL-2022/TEAM_A/blob/main/images/Picture6.png)
